...
do
  ...
  if [[ "$subsneeded" = "NO" ]]; then
	if [[ "$showname_raw" = "My.Cat.From.Hell" ]] || [[ "$showname_raw" = "MythBusters" ]] || [[ "$showname_raw" = "NOVA" ]] || [[ "$showname_raw" = "the.Joy.of.Painting" ]] || [[ "$showname_raw" = "Through.the.Wormhole" ]] || [[ "$showname_raw" = "How.The.Universe.Works" ]] || [[ "$showname_raw" = "Witchblade" ]] || [[ "$showname_raw" = "Looney.Tunes" ]] || [[ "$showname_raw" = "Tom.and.Jerry" ]]; then
